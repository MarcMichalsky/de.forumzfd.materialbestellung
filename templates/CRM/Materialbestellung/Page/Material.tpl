<div class="crm-content-block crm-block">
  <div id="help">
    {ts}This page shows all avaiable material. All active items will be listed on the website.{/ts}
  </div>
  ...
  <div id="fzfd_material-wrapper" class="dataTables_wrapper">
    <table id="fzfd_material-table" class="display">
      ...
      {foreach from=$materialRows key=materialId item=material}
        <tr id="row_{$materialId}" class="{cycle values="odd,even"}">
          <td>{$materialId}</td>
